  ...
  <div class="wrapper">
    <side-bar>
      <template slot="links">
        ...
        <sidebar-link to="/AI" :name="$t('sidebar.AI')" icon="tim-icons icon-world"/>
        <sidebar-link to="/Chat" :name="$t('sidebar.Chat')" icon="tim-icons icon-world"/>
        <sidebar-link to="/Geo" :name="$t('sidebar.Geo')" icon="tim-icons icon-world"/>
      </template>
    </side-bar>
